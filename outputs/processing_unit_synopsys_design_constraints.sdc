...
# Created by write_sdc on Mon Dec  2 01:24:52 2019
...
create_clock [get_ports clock]  -period 2.25  -waveform {0 1.125}
...
set_max_delay 2.25  -to [get_ports input_req]
set_max_delay 2.25  -to [get_ports {output_val[5]}]
set_max_delay 2.25  -to [get_ports {output_val[4]}]
set_max_delay 2.25  -to [get_ports {output_val[3]}]
set_max_delay 2.25  -to [get_ports {output_val[2]}]
set_max_delay 2.25  -to [get_ports {output_val[1]}]
set_max_delay 2.25  -to [get_ports {output_val[0]}]
set_max_delay 2.25  -to [get_ports output_valid]
set_max_delay 2.25  -to [get_ports done]
